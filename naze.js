...
module.exports = naze = async (naze, m, chatUpdate, store) => {
	...
	if (db.data.settings[botNumber].autobio) {
	  ...
	  // Anti Link
        ...
        if (!isBotAdmins) return m.reply(`*Bot belum jadi admin*`)
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
			...
			if (!text) throw `Example : ${prefix + command} hai|bg
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            await naze.sendButtonText('6285607831410@s.whatsapp.net', buttons, pjtxt, nyoutube, m, {mentions: ments})
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: 'Donation' }, type: 1 }]
...
•› Url : ${anu.url}`,
		...
		let buttons = [{ buttonId: 'menu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: 'Donation' }, type: 1 }]
...
╰──❍`
            ...
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'ping', buttonText: { displayText: '🎐Ping' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: 'Donation' }, type: 1 }]
...
_Donasi Ngab_\n_Jangan Ngarep Free Mulu_`
                let buttons = [{ buttonId: 'donasi', buttonText: { displayText: 'Donation' }, type: 1 },{ buttonId: 'ping', buttonText: { displayText: '🎐Ping' }, type: 1 }]
